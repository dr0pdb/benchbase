...
public class YBMicroBenchmarkInsertsSequentialIndexes0ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes0ExpTxn.class);

  public YBMicroBenchmarkInsertsSequentialIndexes0ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1100; id++) {
      String query = String.format(
          "begin; insert into demo values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d); commit;",
