...
public class YBMicroBenchmarkInsertsBatchedIndexes10 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsBatchedIndexes10.class);

  public YBMicroBenchmarkInsertsBatchedIndexes10(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String insertStmt1 = String.format("insert into demo_indexes_10 values %s;", values);
