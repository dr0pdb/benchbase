...
public class YBMicroBenchmarkInsertsSequentialIndexes5ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes5ExpTxn.class);

  public YBMicroBenchmarkInsertsSequentialIndexes5ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1100; id++) {
      String query = String.format(
          "begin; insert into demo_indexes_5 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d); commit;",
