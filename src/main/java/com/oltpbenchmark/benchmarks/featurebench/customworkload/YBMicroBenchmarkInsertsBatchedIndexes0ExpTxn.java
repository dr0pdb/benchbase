...
public class YBMicroBenchmarkInsertsBatchedIndexes0ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsBatchedIndexes0ExpTxn.class);

  public YBMicroBenchmarkInsertsBatchedIndexes0ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String insertStmt1 = String.format("begin; insert into demo values %s; commit;", values);
