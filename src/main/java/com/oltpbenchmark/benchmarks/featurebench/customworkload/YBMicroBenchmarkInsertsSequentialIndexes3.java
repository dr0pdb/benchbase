...
public class YBMicroBenchmarkInsertsSequentialIndexes3 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes3.class);

  public YBMicroBenchmarkInsertsSequentialIndexes3(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1000; id++) {
      String query = String.format(
          "insert into demo_indexes_3 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",
