...
public class YBMicroBenchmarkInsertsSequentialIndexes2ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes2ExpTxn.class);

  public YBMicroBenchmarkInsertsSequentialIndexes2ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1100; id++) {
      String query = String.format(
          "begin; insert into demo_indexes_2 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d); commit;",
