...
public class YBMicroBenchmarkInsertsSequentialIndexes10 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes10.class);

  public YBMicroBenchmarkInsertsSequentialIndexes10(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1000; id++) {
      String query = String.format(
          "insert into demo_indexes_10 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",
