...
public class YBMicroBenchmarkDeletesBatchedIndexes5ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesBatchedIndexes5ExpTxn.class);
  private static final int NUM_ROWS = 1100;
  private String inClause;

  public YBMicroBenchmarkDeletesBatchedIndexes5ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    String batchedDeleteStatement =
        String.format("begin; delete from demo_indexes_5 where id in %s; commit;", inClause);
