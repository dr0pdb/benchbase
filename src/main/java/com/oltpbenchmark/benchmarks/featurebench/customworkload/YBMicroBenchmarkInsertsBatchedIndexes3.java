...
public class YBMicroBenchmarkInsertsBatchedIndexes3 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsBatchedIndexes3.class);

  public YBMicroBenchmarkInsertsBatchedIndexes3(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String insertStmt1 = String.format("insert into demo_indexes_3 values %s;", values);
