...
public class YBMicroBenchmarkDeletesSequentialIndexes2 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesSequentialIndexes2.class);
  private static final int NUM_ROWS = 1000;

  public YBMicroBenchmarkDeletesSequentialIndexes2(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= NUM_ROWS; id++) {
      stmtObj.execute(String.format("delete from demo_indexes_2 where id = %d;", id));
    }
    stmtObj.close();
  }
}
