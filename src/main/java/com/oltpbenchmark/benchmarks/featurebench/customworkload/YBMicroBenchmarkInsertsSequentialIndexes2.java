...
public class YBMicroBenchmarkInsertsSequentialIndexes2 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes2.class);

  public YBMicroBenchmarkInsertsSequentialIndexes2(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1100; id++) {
      String query = String.format(
          "insert into demo_indexes_2 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",
