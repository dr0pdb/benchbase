...
public class YBMicroBenchmarkInsertsBatchedIndexes2ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsBatchedIndexes2ExpTxn.class);
  private String values;

  public YBMicroBenchmarkInsertsBatchedIndexes2ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    String insertStmt1 = String.format("begin; insert into demo_indexes_2 values %s; commit;", values);
