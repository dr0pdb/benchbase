...
public class YBMicroBenchmarkDeletesSequentialIndexes0 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesSequentialIndexes0.class);
  private static final int NUM_ROWS = 1100;

  public YBMicroBenchmarkDeletesSequentialIndexes0(
