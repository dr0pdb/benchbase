...
public class YBMicroBenchmarkUpdatesBatchedIndexes2 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkUpdatesBatchedIndexes2.class);
  private static final int NUM_ROWS = 1000;

  public YBMicroBenchmarkUpdatesBatchedIndexes2(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String batchedUpdateStatement = String.format(
        "update demo_indexes_2 set col1 = col1 + 10000, col2 = col2 + 10000, col3 = col3 + 10000, col4 = col4 + 10000, col5 = col5 + 10000, col6 = col6 + 10000, col7 = col7 + 10000, col8 = col8 + 10000, col9 = col9 + 10000, col10 = col10 + 10000 where id in %s;",
        inClause);
