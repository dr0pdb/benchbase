...
public class YBMicroBenchmarkDeletesSequentialIndexes10ExpTxn extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesSequentialIndexes10ExpTxn.class);
  private static final int NUM_ROWS = 1100;

  public YBMicroBenchmarkDeletesSequentialIndexes10ExpTxn(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= NUM_ROWS; id++) {
      stmtObj.execute(String.format("begin; delete from demo_indexes_10 where id = %d; commit;", id));
    }
    stmtObj.close();
  }
}
