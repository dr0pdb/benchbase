...
public class YBMicroBenchmarkInsertsSequentialIndexes1 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkInsertsSequentialIndexes1.class);

  public YBMicroBenchmarkInsertsSequentialIndexes1(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    for (int id = 101; id <= 1100; id++) {
      String query = String.format(
          "insert into demo_indexes_1 values (%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d)",
