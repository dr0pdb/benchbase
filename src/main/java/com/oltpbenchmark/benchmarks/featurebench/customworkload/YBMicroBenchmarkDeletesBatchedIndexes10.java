...
public class YBMicroBenchmarkDeletesBatchedIndexes10 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesBatchedIndexes10.class);
  private static final int NUM_ROWS = 1000;

  public YBMicroBenchmarkDeletesBatchedIndexes10(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String batchedDeleteStatement =
        String.format("delete from demo_indexes_10 where id in %s", inClause);
