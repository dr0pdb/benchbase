...
public class YBMicroBenchmarkDeletesBatchedIndexes3 extends YBMicroBenchmark {
  public final static Logger LOG =
      Logger.getLogger(com.oltpbenchmark.benchmarks.featurebench.customworkload
                           .YBMicroBenchmarkDeletesBatchedIndexes3.class);
  private static final int NUM_ROWS = 1000;

  public YBMicroBenchmarkDeletesBatchedIndexes3(
  ...
  public void executeOnce(Connection conn) throws SQLException {
    ...
    String batchedDeleteStatement =
        String.format("delete from demo_indexes_3 where id in %s", inClause);
